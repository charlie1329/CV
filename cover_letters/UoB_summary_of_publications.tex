...
%
For dual-arm assembly robots, each arm can reason over where the other is likely to be to avoid collisions or delays, which occur when both arms try to place an object in the same place simultaneously.
