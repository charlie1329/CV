...
\begin{itemize}
\item[\cite{street2024towards}] \fullcite{street2024towards}. \textcolor{red}{Check once published.}
\item[\cite{street2024covered}] \fullcite{street2024covered}.
\item[\cite{zhang2024decoupled}] \fullcite{zhang2024decoupled}. \textcolor{red}{PUT VOLUME NO. AND PAGES ONCE PUBLISHED.}
\item[\cite{street2024right}] \fullcite{street2024right}.
\item[\cite{street2023formal}] \fullcite{street2023formal}.
